...
#include "filestore/FileSystemStorage.h"
#include "metastore/IFileMetaStore.h"
#include "metacache/IFileMetaCache.h"
...
public:
    ...
    // - 只关心 upload/download 的业务流程，以及对 filestore/metastore/metacache 的调用
